...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 font-sans">
      ...
      {/* Footer Section */}
      <footer className="py-16 bg-gradient-to-r from-primary-800 to-sky-900 text-white">
        <div className="w-11/12 mx-auto px-4 sm:px-6 lg:px-8 w-11/12">
          <motion.div
            initial="hidden"
            whileInView="visible"
          ...
          >
            <motion.div variants={itemVariants} className="text-center md:text-left">
              <h4 className="text-xl font-bold mb-4">Aby Inventory</h4>
              <p className="text-primary-200 leading-relaxed">
                Empowering businesses with seamless inventory and financial management solutions.
              </p>
            ...
            <motion.div variants={itemVariants} className="text-center">
              ...
              <ul className="space-y-2">
                <li>
                  <a href="#" className="text-primary-200 hover:text-white transition-colors duration-300">Home</a>
                </li>
                <li>
                  <a href="#" className="text-primary-200 hover:text-white transition-colors duration-300">Features</a>
                </li>
                <li>
                  <a href="#" className="text-primary-200 hover:text-white transition-colors duration-300">Pricing</a>
                </li>
                <li>
                  <a href="#" className="text-primary-200 hover:text-white transition-colors duration-300">Contact</a>
                </li>
              </ul>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="text-center md:text-right">
              ...
              <p className="text-primary-200 mb-4">Stay updated with our latest features and insights.</p>
              <div className="flex flex-col sm:flex-row gap-2">
                <input
                  type="email"
                  placeholder="Enter your email"
                  className="px-4 py-2 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-primary-400"
                />
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="bg-primary-600 text-white px-4 py-2 rounded-lg hover:bg-primary-700 transition-all duration-300"
                >
                  Subscribe
                </motion.button>
              </div>
          ...
          <motion.div
            variants={itemVariants}
            className="mt-12 text-center text-primary-200"
          >
            <p>&copy; {new Date().getFullYear()} Aby Inventory. All rights reserved.</p>
          </motion.div>
        </div>
      </footer>
    </div>
